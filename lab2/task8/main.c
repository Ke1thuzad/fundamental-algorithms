...
int main() {
    ...
    err = base_sum(36, &result, 4, "z", "z", "0", "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
    if (err) {
        destroy(&result);
        return err;
    }
